...
contract RecoveryController {
    ...
    address public constant RECOVERY_WALLET = address(0x1514E1d289157F5403B80872bd82FAF7CBA1843C); // replace recovery wallet address

    constructor() {
    }

    function recover() external {
        uint recoveryAmount = IERC20(WCFG).balanceOf(RWA_VAULT);    
