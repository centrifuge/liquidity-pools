...
contract LiquidityPool is Auth, IERC4626 {
    ...
    function convertToShares(uint256 assets) public view returns (uint256 shares) {
        shares = assets.mulDiv(10 ** investmentManager.PRICE_DECIMALS(), latestPrice, MathLib.Rounding.Down);
    }
    ...
    function convertToAssets(uint256 shares) public view returns (uint256 assets) {
        assets = shares.mulDiv(latestPrice, 10 ** investmentManager.PRICE_DECIMALS(), MathLib.Rounding.Down);
    }
