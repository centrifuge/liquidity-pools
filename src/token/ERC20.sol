...
contract ERC20 is Auth {
    ...
    function approveForOwner(address owner, address spender, uint256 value) external auth returns (bool) {
     ...
     function increaseAllowanceForOwner(address owner, address spender, uint256 addedValue) external auth returns (bool) {
    ...
    function decreaseAllowanceForOwner(address owner, address spender, uint256 subtractedValue) external auth returns (bool) {
