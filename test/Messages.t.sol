...
contract MessagesTest is Test {
    ...
    function testAddTrancheDecoding() public {
        (
            ...
            fromHex(
                ""
            ).ref(0)
        );
    ...
    function testCollectInvestEncoding() public {
        assertEq(
            ...
            hex"0f0000000000000002811acd5b3f17c06841c7e41e9e04cb1b1231231231231231231231231231231231231231231231231231231231231231"
        );
    }
    ...
    function testCollectForInvestEncoding() public {
        assertEq(
            ...
            hex"100000000000000002811acd5b3f17c06841c7e41e9e04cb1b11111111111111111111111111111111111111111111111111111111111111112222222222222222222222222222222222222222222222222222222222222222"
        );
    }
    ...
    function testCollectForInvestDecoding() public {
        (uint64 decodedPoolId, bytes16 decodedTrancheId, bytes32 decodedCaller, bytes32 decodedUser) = ConnectorMessages
            ...
            fromHex(
                "100000000000000002811acd5b3f17c06841c7e41e9e04cb1b11111111111111111111111111111111111111111111111111111111111111112222222222222222222222222222222222222222222222222222222222222222"
            ).ref(0)
        );
        assertEq(uint256(decodedPoolId), uint256(2));
        assertEq(decodedTrancheId, hex"811acd5b3f17c06841c7e41e9e04cb1b");
