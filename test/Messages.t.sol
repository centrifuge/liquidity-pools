...
contract MessagesTest is Test {
    ...
    // TODO(nuno): This is now using `parseAddTrancheB`
    function testAddTrancheDecoding() public {
        (uint64 decodedPoolId, bytes16 decodedTrancheId, string memory decodedTokenName, string memory decodedTokenSymbol, uint128 decodedPrice) = ConnectorMessages.parseAddTrancheB(fromHex("").ref(0));
