...
import {ERC4626PropertyTest} from "test/ERC4626Properties/ERC4626Properties.t.sol";

contract ERC4626FunctionalAccounting is ERC4626PropertyTest {
    ...
    function test_depositProperties(uint256 receiverId, uint256 tokens) public {
        address sender = address(this);
        address receiver = restrictAddressToThirdParties(receiverId);
        vm.prank(address(gateway));
        poolManager.updateMember(poolId, trancheId, sender, uint64(block.timestamp + 1000 days));
        vault.requestDeposit(tokens, sender);
    ...
    // function test_mintProperties(uint256 receiverId, uint256 shares) public {
    //     address sender = address(this);
    //     address receiver = restrictAddressToThirdParties(receiverId);
    ...
    // function test_redeemProperties(uint256 receiverId, uint256 shares) public {
    ...
    // function test_withdrawProperties(uint256 receiverId, uint256 tokens) public {
