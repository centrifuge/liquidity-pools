...
//         assertEq(MessagesLib.formatAddTranche(poolId, trancheId, name, symbol, decimals, restrictionSet),
// expectedHex);
...
//     // Note: UpdateMember encodes differently in Solidity compared to the Rust counterpart because `user` is a
// 20-byte
...
//         bytes memory _message = MessagesLib.formatUpdateTrancheTokenMetadata(poolId, trancheId, tokenName,
// tokenSymbol);
//         (
//             uint64 decodedPoolId,
//             bytes16 decodedTrancheId,
...
//         uint128 amount
//     ) public {
//         bytes memory _message = MessagesLib.formatTriggerIncreaseRedeemOrder(poolId, trancheId, investor, token,
// amount);
//         (
//             uint64 decodedPoolId,
//             bytes16 decodedTrancheId,
