...
- [**Tranche Token**](https://github.com/centrifuge/liquidity-pools/blob/main/src/token/TrancheToken01.sol): An [ERC-20](https://ethereum.org/en/developers/docs/standards/tokens/erc-20/) token for the tranche that manages transfer restrictions. Prices for tranche tokens are computed on Centrifuge.
