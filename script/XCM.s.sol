...
contract XCMScript is Script {
    ...
    function run() public {
        ...
        address liquidityPoolFactory_ = address(new LiquidityPoolFactory{ salt: SALT }());
        address memberlistFactory_ = address(new MemberlistFactory{ salt: SALT }());
        address escrow_ = address(new Escrow{ salt: SALT }());
        InvestmentManager investmentManager =
            new InvestmentManager{ salt: SALT }(escrow_, liquidityPoolFactory_, tokenFactory_, memberlistFactory_);
